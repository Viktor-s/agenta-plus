 ...
 */
class Version20151114134833 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE orders (id UUID NOT NULL, creator_id UUID NOT NULL, client_id UUID NOT NULL, stage_id UUID NOT NULL, currency VARCHAR(3) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, amount NUMERIC(10, 4) NOT NULL, PRIMARY KEY(id))');
